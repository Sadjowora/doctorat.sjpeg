    ...
    <div className={styles.services}>
      <div className="flex-column justify-content-between m-4">
       <div className="d-flex justify-content-center"> <h1 style={{color: "#2e86c1"}}> Les formations que nous offrons  </h1> </div>
        ...
        <Link href="/components/formations" className={styles.card}>
        ...
        <Link href="/components/formations" className={styles.card}>
          <img src="/images/science-economique.jpg" alt="image science-juridique" />
          <div className="flex-column">
        ...
        <Link href="/components/formations" className={styles.card}>
          <img src="/images/science-gestion.webp" alt="science-gestion" />
          <div className="flex-column">
