      ...
      <div className={styles.vocation}>
            <div className={styles.vocationCard}>
              <div className="flex-column">
                  <h1> <strong style={{color:"tomato"}}> Envoyez </strong> ou faites vous <strong style={{color:"tomato"}}> livrer </strong> ce que vous voulez <strong style={{color:"tomato"}}> où vous voulez </strong> dans Conakry !  </h1>
                   ...
                   <div> <button className="btn btn-outline-danger mt-4"> S'inscrire comme utilisateur </button> </div>
               </div>
               <div> <img src="/images/noullal-smart-livreur.png" alt="abordable" />
               </div>
            </div>
              ...
              <div className={"flex-column "+styles.vocationFooter}>
                  <h1> Soyez  <strong style={{color:"dodgerblue"}}> livreur </strong>, <strong style={{color:"dodgerblue"}}> expéditeur </strong> ou <strong style={{color:"dodgerblue"}}> destinataire ! </strong>  </h1>
                   <p>Sur l’application de livraison de colis Noullal les utilisateurs peuvent avoir plusieurs casquettes.
                       Vous avez acheté un meuble sur makiti et souhaitez vous le faire livrer ?
                       Vos déplacements vous coûtent cher et vous cherchez une façon de réduire vos frais ? Avez Noullal, envoyez, recevez des colis de toutes sortes ! </p>
